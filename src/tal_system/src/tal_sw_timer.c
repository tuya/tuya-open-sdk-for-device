...
STATIC VOID_T __timer_dispatch(SYS_TIME_T *next_expired)
{
    TIME_S nowSecTime = 0;
    TIME_MS nowMsTime = 0;
    UINT64_T nowMS = 0;
...
STATIC VOID_T __timer_thread_cb(VOID_T  *data)
{
...
//used for debug
VOID_T tal_sw_timer_dump(VOID_T)
{
