...
struct ble_hs_cfg {
    ...
    /* XXX: These need to go away. Instead, the tuya ble host package should
...
/**
 * Causes the host to reset the tuya ble stack as soon as possible.  The
...
/**
 * Designates the specified event queue for tuya ble host work. By default, the
 ...
 */
void ble_hs_evq_set(tuya_ble_eventq *evq);

/**
 * Initializes the tuya ble host. This function must be called before the OS is
 * started. The tuya ble stack requires an application task to function.  One
 ...
 * tuya ble host by processing events generated by the host.
 */
