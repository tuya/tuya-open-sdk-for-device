 ...
 * 
 * This header file defines the software I2C (Inter-Integrated Circuit) interface for devices, providing a software-based solution for I2C communication. 
 * It includes definitions for initializing and deinitializing the I2C interface, configuring I2C pins, and transferring data over the I2C bus using software bit-banging. 
 * The interface supports both read and write operations, handling of 10-bit addressing, and various flags for customizing the I2C communication behavior.
 * 
 * The software I2C implementation is particularly useful for devices that do not have hardware I2C support or require additional I2C interfaces beyond what is available in hardware. I
 * t allows for flexible I2C communication using any general-purpose input/output (GPIO) pins.
 * 
...
***********************typedef define***********************
***********************************************************/
typedef UCHAR_T SW_I2C_PORT_NUM_E;
