/**
 * @file crc32i.c
 * @brief Implementation of CRC-32 calculation.
 *
...
/**
 * @brief Initializes the CRC32I hash function.
 *
 * @return The initial value for the CRC32I hash function.
 */
 ...
 *
 * This function takes an existing CRC32I hash value, along with a pointer to
 * data and its size, and updates the hash value by incorporating the data. The
...
/**
 * @brief Finishes the CRC32I hash calculation.
 *
 * This function takes the intermediate hash value and finalizes the CRC32I hash
 * calculation.
 *
