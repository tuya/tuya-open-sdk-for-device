...
*/
OPERATE_RET tal_uart_read(TUYA_UART_NUM_E port_num, UINT8_T *data, UINT32_T len)
{
    if (data == NULL) {
        return OPRT_INVALID_PARM;
    }
...
*/
OPERATE_RET tal_uart_write(TUYA_UART_NUM_E port_num, CONST UINT8_T *data, UINT32_T len)
{
    if (data == NULL) {
        return OPRT_INVALID_PARM;
    }
