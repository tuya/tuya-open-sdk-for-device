...
STATIC VOID_T __work_thread_cb(VOID_T  *data)
{
...
STATIC BOOL_T __work_cancel_traverse(VOID_T *item, VOID_T *ctx)
{
...
VOID_T __delayed_work_cb(TIMER_ID timer_id, VOID_T *arg)
{
