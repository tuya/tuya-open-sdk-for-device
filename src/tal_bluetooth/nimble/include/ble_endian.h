...
#if defined (__BYTE_ORDER__) && (__BYTE_ORDER__ == __ORDER_BIG_ENDIAN__)  // [Tim][Cheng] Fix issue, while using in soc platform, we will use big endian if not define two values
