...
typedef int32_t (*tuya_tls_send_cb)(void *p_custom_net_ctx, const BYTE_T *buf, SIZE_T len);
typedef int32_t (*tuya_tls_recv_cb)(void *p_custom_net_ctx, BYTE_T *buf, SIZE_T len);
