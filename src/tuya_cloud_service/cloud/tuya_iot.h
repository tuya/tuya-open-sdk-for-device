...
((S) == TUYA_EVENT_DP_RECEIVE_OBJ ? "TUYA_EVENT_DP_RECEIVE_OBJ":\
((S) == TUYA_EVENT_DP_RECEIVE_RAW ? "TUYA_EVENT_DP_RECEIVE_RAW":\
((S) == TUYA_EVENT_DIRECT_MQTT_CONNECTED ? "TUYA_EVENT_DIRECT_MQTT_CONNECTED":\
"Unknown"))))))))))))))))
...
#define MAX_LENGTH_WIFI_PWD     64

typedef struct {
    char ssid[MAX_LENGTH_WIFI_SSID + 1];
    char passwd[MAX_LENGTH_WIFI_PWD + 1];
